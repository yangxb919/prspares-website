...
interface HomeQuoteButtonProps {
  label?: string;
  product?: string;
  eventLabel?: string;
  variant?: 'primary' | 'secondary' | 'outline' | 'float' | 'footer' | 'footer-wa';
  className?: string;
}

export default function HomeQuoteButton({
  label = 'Get Wholesale Quote',
  product = 'Wholesale Phone Parts',
  eventLabel = 'Home CTA',
  variant = 'primary',
  className = '',
}: HomeQuoteButtonProps) {
  ...
  const baseStyles: Record<string, string> = {
    primary: 'inline-flex items-center justify-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 px-8 rounded-lg text-lg shadow-lg transition-all hover:-translate-y-0.5',
    ...
    outline: 'inline-flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 text-white font-semibold py-4 px-8 rounded-lg text-lg border border-white/20 transition-all',
    ...
    footer: 'inline-flex items-center justify-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 px-8 rounded-lg text-lg shadow-lg transition-all hover:-translate-y-0.5',
  };
