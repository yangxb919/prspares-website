...
const PRODUCT_TYPES = [
  { name: 'iPhone OLED/LCD', desc: 'Full range from iPhone 6 to iPhone 16 series. Supports True Tone with programmer.' },
  { name: 'Samsung AMOLED', desc: 'Galaxy S, A, Note, and Z Fold/Flip series. Original and aftermarket options.' },
  { name: 'Huawei/Xiaomi/OPPO Displays', desc: 'P, Mate, Nova, Mi, Redmi, POCO, Reno, and Find series screens.' },
  { name: 'iPad Screens', desc: 'iPad, iPad Air, iPad Pro, and iPad Mini LCD and digitizer assemblies.' },
];
