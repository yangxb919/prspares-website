...
const metaDescription =
  'Wholesale iPhone and Samsung LCD/OLED screens from Shenzhen. No single-model MOQ - mix screen models and grades to reach the 10-pcs order minimum. Grade options, batch QC, warranty support and fast quote for shops worldwide.';
