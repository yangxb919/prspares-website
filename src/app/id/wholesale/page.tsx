            ...
            <div className="space-y-4 lg:col-span-2">
              ...
              <div data-scroll-reveal="right" style={revealStyle(180)} className={`rounded-lg border border-[#ded6c8] bg-white p-6 shadow-sm ${styles.motionCard}`}>
                ...
                <div className="space-y-3">
                  ...
                  <a href="mailto:parts.info@phonerepairspares.com" className="flex items-center gap-3 text-sm font-semibold text-[#27313c] transition-colors hover:text-[#0b6b45]" onClick={() => trackEvent('email_click', { ...TRACK_BASE, placement: 'id_wholesale_contact_card' })}>
