      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50">
        <div className="text-center max-w-md">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/20">
            ...
            <p className="text-gray-900 mb-6">Verifying your identity...</p>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-red-50">
        <div className="text-center max-w-md">
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20">
            ...
            <div className="text-gray-900 mb-6" dangerouslySetInnerHTML={{ __html: error }}></div>
            ...
            <div className="flex flex-col space-y-3">
              ...
              <div className="flex space-x-3">
                ...
                <Link href="/" className="flex-1 border-2 border-gray-200 text-gray-900 px-4 py-2 rounded-lg font-medium hover:bg-gray-50 transition-all duration-200 text-center">
                  Home
                </Link>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="hidden md:flex items-center space-x-2 bg-white/50 px-4 py-2 rounded-full border border-white/30">
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-gray-800 capitalize">{user?.role}</p>
                </div>
              </div>
              <button
                onClick={async () => {
